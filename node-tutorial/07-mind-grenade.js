...
// Below code(line 11) should be run in some other file
// require('./07-mind-grenade');

// when we run this code, eg :
...
// some kind of function(like addValues() on line 8) that actually is executed here.
